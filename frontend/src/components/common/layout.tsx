...
function Layout() {
    ...
    useEffect(() => {
        ...
        setPopup({
            visible: true,
            message: `Please note: The Wizard may struggle with noise or low volume but works well if clean clips of known songs are fed directly. You can do that from this link`,
            link: `${API_URL}/docs`,
        });
    }, []);
